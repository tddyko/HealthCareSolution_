...
import com.gchc.ing.charting.formatter.DefaultFillFormatter;
import com.gchc.ing.charting.formatter.IFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<CEntry> implements ILineDataSet {
    ...
    public LineDataSet(List<CEntry> yVals, String label) {
        super(yVals, label);
