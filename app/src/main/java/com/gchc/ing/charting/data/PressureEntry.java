...
public class PressureEntry extends CEntry {
     ...
     */
    public PressureEntry(float x, float shadowH, float shadowL, float open, float close) {
    ...
    public PressureEntry copy() {

        PressureEntry c = new PressureEntry(getX(), mShadowHigh, mShadowLow, mOpen,
                mClose, getData());
        return c;
    }
