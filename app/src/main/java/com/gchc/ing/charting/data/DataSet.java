...
/**
 * The DataSet class represents one group or type of entries (CEntry) in the
 ...
 */
public abstract class DataSet<T extends CEntry> extends BaseDataSet<T> {
    ...
    /**
     * Updates the min and max x and y value of this DataSet based on the given CEntry.
     *
     * @param e
     */
    ...
    @Override
    public int getEntryIndex(CEntry e) {
        ...
        if (closest != -1) {
            ...
            if (!Float.isNaN(closestToY)) {
                ...
                while (true) {
                    ...
                    final CEntry value = mValues.get(closest);
