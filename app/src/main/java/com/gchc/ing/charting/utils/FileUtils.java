...
public class FileUtils {
     ...
     * @return
     */
    public static List<CEntry> loadEntriesFromFile(String path) {
        ...
        List<CEntry> entries = new ArrayList<CEntry>();
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new CEntry(Float.parseFloat(split[0]), Integer.parseInt(split[1])));
                } else {
     ...
     * @return
     */
    public static List<CEntry> loadEntriesFromAssets(AssetManager am, String path) {
        ...
        try {
            ...
            while (line != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new CEntry(Float.parseFloat(split[1]), Float.parseFloat(split[0])));
                } else {
     ...
     * @param path
     */
    public static void saveToSdCard(List<CEntry> entries, String path) {
