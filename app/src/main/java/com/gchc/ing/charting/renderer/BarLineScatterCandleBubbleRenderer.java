...
public abstract class BarLineScatterCandleBubbleRenderer extends DataRenderer {
     ...
     * @return
     */
    protected boolean isInBoundsX(CEntry e, IBarLineScatterCandleBubbleDataSet set) {
    ...
    protected class XBounds {
        ...
        public void set(BarLineScatterCandleBubbleDataProvider chart, IBarLineScatterCandleBubbleDataSet dataSet) {
            ...
            CEntry entryFrom = dataSet.getEntryForXValue(low, Float.NaN, DataSet.Rounding.DOWN);
            CEntry entryTo = dataSet.getEntryForXValue(high, Float.NaN, DataSet.Rounding.UP);
