...
import com.gchc.ing.charting.highlight.BarHighlighter;
...
import com.gchc.ing.charting.renderer.WeightChartRenderer;
 ...
 */
public class WeightChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    /**
     * Returns the bounding box of the specified CEntry in the specified DataSet. Returns null if the CEntry could not be
    ...
    /**
     * The passed outputRect will be assigned the values of the bounding box of the specified CEntry in the specified DataSet.
     * The rect will be assigned Float.MIN_VALUE in all locations if the CEntry could not be found in the charts data.
     *
     * @param e
     * @return
     */
