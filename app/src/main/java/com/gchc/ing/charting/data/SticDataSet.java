 ...
 */
public class SticDataSet extends LineScatterCandleRadarDataSet<SticEntry> implements ISticDataSet {
    ...
    /**
     * should the candle bars showDlg?
    ...
    public SticDataSet(List<SticEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public DataSet<SticEntry> copy() {

        List<SticEntry> yVals = new ArrayList<SticEntry>();
        yVals.clear();
        ...
        SticDataSet copied = new SticDataSet(yVals, getLabel());
    ...
    @Override
    protected void calcMinMax(SticEntry e) {
    ...
    @Override
    protected void calcMinMaxY(SticEntry e) {
    ...
    /**
     * Sets whether the candle bars should showDlg?
     *
     * @param showCandleBar
     */
