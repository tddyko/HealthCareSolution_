...
import com.gchc.ing.charting.interfaces.datasets.IBubbleDataSet;
...
public class Transformer {
    ...
    /**
     * Transforms an List of CEntry into a float array containing the x and
    ...
    public float[] generateTransformedValuesScatter(IScatterDataSet data, float phaseX,
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            CEntry e = data.getEntryForIndex(j / 2 + from);
    ...
    public float[] generateTransformedValuesLine(ILineDataSet data,
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            CEntry e = data.getEntryForIndex(j / 2 + min);
