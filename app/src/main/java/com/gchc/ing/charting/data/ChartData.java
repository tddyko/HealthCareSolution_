 ...
 */
public abstract class ChartData<T extends IDataSet<? extends CEntry>> {
    ...
    /**
     * Get the CEntry for a corresponding highlight object
     *
     * @param highlight
     * @return the entry that is highlighted
     */
    public CEntry getEntryForHighlight(Highlight highlight) {
    ...
    /**
     * Adds an CEntry to the DataSet at the specified index.
     * Entries are added to the end of the list.
     *
     * @param e
     * @param dataSetIndex
     */
    public void addEntry(CEntry e, int dataSetIndex) {
        ...
        if (mDataSets.size() > dataSetIndex && dataSetIndex >= 0) {
            ...
            Log.e("addEntry", "Cannot add CEntry because dataSetIndex too high or too low.");
        }
    }

    /**
     * Adjusts the current minimum and maximum values based on the provided CEntry object.
     *
     * @param e
     * @param axis
     */
    protected void calcMinMax(CEntry e, AxisDependency axis) {
    ...
    /**
     * Removes the given CEntry object from the DataSet at the specified index.
     *
     * @param e
     * @param dataSetIndex
     */
    public boolean removeEntry(CEntry e, int dataSetIndex) {
    ...
    /**
     * Removes the CEntry object closest to the given DataSet at the
     * specified index. Returns true if an CEntry was removed, false if no CEntry
    ...
    public boolean removeEntry(float xValue, int dataSetIndex) {
        ...
        CEntry e = dataSet.getEntryForXValue(xValue, Float.NaN);
    ...
    /**
     * Returns the DataSet that contains the provided CEntry, or null, if no
     * DataSet contains this CEntry.
     *
     * @param e
     * @return
     */
    public T getDataSetForEntry(CEntry e) {
