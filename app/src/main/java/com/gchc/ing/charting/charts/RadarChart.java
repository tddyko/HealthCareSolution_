...
import com.gchc.ing.charting.highlight.RadarHighlighter;
import com.gchc.ing.charting.renderer.RadarChartRenderer;
import com.gchc.ing.charting.renderer.XAxisRendererRadarChart;
import com.gchc.ing.charting.renderer.YAxisRendererRadarChart;
...
public class RadarChart extends PieRadarChartBase<RadarData> {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mXAxisRenderer.renderAxisLabels(canvas);    // 레이더차트 라벨 텍스트
