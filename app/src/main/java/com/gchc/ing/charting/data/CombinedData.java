 ...
 */
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends CEntry>> {
    ...
    public void calcMinMax() {
        ...
        for (ChartData data : allData) {
            ...
            List<IBarLineScatterCandleBubbleDataSet<? extends CEntry>> sets = data.getDataSets();
    ...
    public CEntry getEntryForHighlight(Highlight highlight) {
        ...
        if (highlight.getDataSetIndex() >= data.getDataSetCount())
            ...
            List<CEntry> entries = data.getDataSetByIndex(highlight.getDataSetIndex())
    ...
    @Override
    public boolean removeDataSet(IBarLineScatterCandleBubbleDataSet<? extends CEntry> d) {
