...
import com.gchc.ing.charting.animation.EasingFunction;
import com.gchc.ing.charting.components.Description;
import com.gchc.ing.charting.components.IMarker;
...
import com.gchc.ing.charting.formatter.DefaultValueFormatter;
...
import com.gchc.ing.charting.highlight.IHighlighter;
import com.gchc.ing.charting.interfaces.dataprovider.ChartInterface;
import com.gchc.ing.charting.interfaces.datasets.IDataSet;
import com.gchc.ing.charting.listener.ChartTouchListener;
import com.gchc.ing.charting.listener.OnChartGestureListener;
import com.gchc.ing.charting.listener.OnChartValueSelectedListener;
import com.gchc.ing.charting.renderer.DataRenderer;
import com.gchc.ing.charting.renderer.LegendRenderer;
 ...
 */
@SuppressLint("NewApi")
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends CEntry>>> extends
        ViewGroup
    ...
    public void setData(T data, ChartTimeUtil timeClass) {
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            CEntry e = mData.getEntryForHighlight(mIndicesToHighlight[i]);
