...
import com.gchc.ing.charting.charts.ScatterChart;
import com.gchc.ing.charting.interfaces.datasets.IScatterDataSet;
import com.gchc.ing.charting.renderer.scatter.ChevronDownShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.ChevronUpShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.CircleShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.CrossShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.IShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.SquareShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.TriangleShapeRenderer;
import com.gchc.ing.charting.renderer.scatter.XShapeRenderer;
import com.gchc.ing.charting.utils.ColorTemplate;

import java.util.ArrayList;
import java.util.List;

public class ScatterDataSet extends LineScatterCandleRadarDataSet<CEntry> implements IScatterDataSet {
    ...
    public ScatterDataSet(List<CEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public DataSet<CEntry> copy() {

        List<CEntry> yVals = new ArrayList<CEntry>();
