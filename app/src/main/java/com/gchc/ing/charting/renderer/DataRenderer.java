...
public abstract class DataRenderer extends Renderer {
    ...
    /**
     * MrSohn 그래프 상단 값 텍스트 그리기
     *
     * @param c            canvas
     * @param formatter    formatter for custom value-formatting
     * @param value        the value to be drawn
     * @param entry        the entry the value belongs to
     * @param dataSetIndex the index of the DataSet the drawn CEntry belongs to
     * @param x            position
     * @param y            position
     * @param color
     */
    public void drawValue(Canvas c, IValueFormatter formatter, float value, CEntry entry, int dataSetIndex, float x, float y, int color) {
