...
public class Tr_content_special_bbslist extends BaseData {
    private final String TAG = Tr_content_special_bbslist.class.getSimpleName();
    ...
    public Tr_content_special_bbslist() {
    ...
    public JSONObject makeJson(Object obj) throws JSONException {
        ...
        if (obj instanceof Tr_content_special_bbslist.RequestData) {
            JSONObject body = new JSONObject();

            Tr_content_special_bbslist.RequestData data = (Tr_content_special_bbslist.RequestData) obj;
            body.put("api_code", "content_special_bbslist"); // content_special_bbslist
