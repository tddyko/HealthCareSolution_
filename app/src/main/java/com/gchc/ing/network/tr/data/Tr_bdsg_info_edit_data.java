...
public class Tr_bdsg_info_edit_data extends BaseData {
    private final String TAG = Tr_bdsg_info_edit_data.class.getSimpleName();
    ...
    public JSONObject makeJson(Object obj) throws JSONException {
        ...
        if (obj instanceof Tr_bdsg_info_edit_data.RequestData) {
            JSONObject body = new JSONObject();
            Tr_bdsg_info_edit_data.RequestData data = (Tr_bdsg_info_edit_data.RequestData) obj;
    ...
    public JSONArray getArray(Tr_get_hedctdata.DataList dataList) {
        JSONArray array = new JSONArray();
            ...
            try {
                ...
                obj.put("sugar" , dataList.sugar ); //1200",
                obj.put("hiLow" , dataList.hilow ); //50",
                obj.put("before" , dataList.before ); //580",
                obj.put("drugname" , dataList.drugname ); //150"ㅈ
