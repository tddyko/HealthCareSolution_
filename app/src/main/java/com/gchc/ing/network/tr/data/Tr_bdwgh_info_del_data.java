...
public class Tr_bdwgh_info_del_data extends BaseData {
    private final String TAG = Tr_bdwgh_info_del_data.class.getSimpleName();
    ...
    public JSONObject makeJson(Object obj) throws JSONException {
        ...
        if (obj instanceof Tr_bdwgh_info_del_data.RequestData) {
            JSONObject body = new JSONObject();
            Tr_bdwgh_info_del_data.RequestData data = (Tr_bdwgh_info_del_data.RequestData) obj;
