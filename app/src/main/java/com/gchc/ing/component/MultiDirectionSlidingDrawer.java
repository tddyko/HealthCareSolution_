...
public class MultiDirectionSlidingDrawer extends ViewGroup {
    ...
    private ImageView mControlImgBtn;
    ...
    public void setVisibleBlockView(boolean isVisible) {
        if (mBlockView != null) {
            mBlockView.setVisibility(isVisible ? View.VISIBLE : View.GONE);
        }

        if (mControlImgBtn != null) {
            mControlImgBtn.setImageResource(isVisible ? R.drawable.btn_up : R.drawable.btn_down);
        }

        if (isVisible) {
            if (mMainFragment != null)
                mMainFragment.slideNewIconInvisible();
        }
    }

    public void setBlockView(View mBlockView) {
        this.mBlockView = mBlockView;
    }

    public ImageView getmControlImgBtn() {
        return mControlImgBtn;
    }

    public void setControlImgBtn(ImageView mControlImgBtn) {
        this.mControlImgBtn = mControlImgBtn;
    }
