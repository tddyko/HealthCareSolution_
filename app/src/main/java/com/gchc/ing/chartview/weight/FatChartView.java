...
public class FatChartView implements OnChartValueSelectedListener {
    ...
    public FatChartView(Context context, View v) {
        mContext = context;
        ...
        mChart = (WeightChart) v.findViewById(R.id.chart2);
        ...
        leftAxis.setAxisMaximum(50f); // this replaces setStartAtZero(true)
