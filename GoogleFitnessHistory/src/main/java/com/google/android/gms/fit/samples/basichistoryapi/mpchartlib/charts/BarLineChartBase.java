...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.components.XAxis.XAxisPosition;
...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.jobs.AnimatedMoveViewJob;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.jobs.AnimatedZoomJob;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.jobs.MoveViewJob;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.jobs.ZoomJob;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.listener.BarLineChartTouchListener;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.listener.OnDrawListener;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.renderer.XAxisRenderer;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.renderer.YAxisRenderer;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
        IBarLineScatterCandleBubbleDataSet<? extends ChartEntry>>>
     ...
     * Returns the position (in pixels) the provided ChartEntry has inside the chart
     * view or null, if the provided ChartEntry is null.
     *
     * @param e
     * @return
     */
    public MPPointF getPosition(ChartEntry e, AxisDependency axis) {
    ...
    /**
     * returns the ChartEntry object displayed at the touched position of the chart
     *
     * @param x
     * @param y
     * @return
     */
    public ChartEntry getEntryByTouchPoint(float x, float y) {
