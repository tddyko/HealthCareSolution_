...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.charts.BarLineChartBase;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.charts.HorizontalBarChart;
...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
        extends IBarLineScatterCandleBubbleDataSet<? extends ChartEntry>>>> {
    ...
    public BarLineChartTouchListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends
            IBarLineScatterCandleBubbleDataSet<? extends ChartEntry>>> chart, Matrix touchMatrix, float dragTriggerDistance) {
        super(chart);
