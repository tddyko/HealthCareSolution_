...
public class ChartEntry extends BaseEntry implements Parcelable {
    ...
    /**
     * A ChartEntry represents one single entry in the chart.
     *
     * @param x the x value
     ...
     */
    public ChartEntry(float x, float y, Object data) {
        super(y, data);
        this.x = x;
    }
     ...
     */
    public ChartEntry(float x, float y, Drawable icon) {
        super(y, icon);
        this.x = x;
    }
     ...
     * @param data Spot for additional data this ChartEntry represents.
     */
    public ChartEntry(float x, float y, Drawable icon, Object data) {
        super(y, icon, data);
        this.x = x;
    }

    /**
     * Returns the x-value of this ChartEntry object.
     * 
     * @return
     */
    public float getX() {
    ...
    /**
     * Sets the x-value of this ChartEntry object.
     * 
     * @param x
     */
     ...
     * @return
     */
    public ChartEntry copy() {
        ChartEntry e = new ChartEntry(x, getY(), getData());
        return e;
    }
     ...
     * @return
     */
    public boolean equalTo(ChartEntry e) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (getData() != null) {
            if (getData() instanceof Parcelable) {
                ...
                throw new ParcelFormatException("Cannot parcel an ChartEntry with non-parcelable data");
            }
        } else {
            dest.writeInt(0);
        }
