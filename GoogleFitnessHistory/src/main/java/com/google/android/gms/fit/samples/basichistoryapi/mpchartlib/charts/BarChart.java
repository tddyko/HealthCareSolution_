...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.highlight.BarHighlighter;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.highlight.Highlight;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.interfaces.dataprovider.BarDataProvider;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.interfaces.datasets.IBarDataSet;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.renderer.BarChartRenderer;
...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    /**
     * Returns the bounding box of the specified ChartEntry in the specified DataSet. Returns null if the ChartEntry could not be
     * found in the charts data.  Performance-intensive code should use void getBarBounds(BarChartEntry, RectF) instead.
     *
     * @param e
     * @return
     */
    public RectF getBarBounds(BarChartEntry e) {
    ...
    /**
     * The passed outputRect will be assigned the values of the bounding box of the specified ChartEntry in the specified DataSet.
     * The rect will be assigned Float.MIN_VALUE in all locations if the ChartEntry could not be found in the charts data.
     *
     * @param e
     * @return
     */
    public void getBarBounds(BarChartEntry e, RectF outputRect) {
