...
public class RadarDataSet extends LineRadarDataSet<RadarChartEntry> implements IRadarDataSet {
    ...
    public RadarDataSet(List<RadarChartEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    @Override
    public DataSet<RadarChartEntry> copy() {

        List<RadarChartEntry> yVals = new ArrayList<RadarChartEntry>();
