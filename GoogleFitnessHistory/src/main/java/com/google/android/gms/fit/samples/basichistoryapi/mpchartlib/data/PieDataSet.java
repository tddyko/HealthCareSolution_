...
public class PieDataSet extends DataSet<PieChartEntry> implements IPieDataSet {
    ...
    public PieDataSet(List<PieChartEntry> yVals, String label) {
        super(yVals, label);
//        mShift = Utils.convertDpToPixel(12f);
    }

    @Override
    public DataSet<PieChartEntry> copy() {

        List<PieChartEntry> yVals = new ArrayList<>();
    ...
    @Override
    protected void calcMinMax(PieChartEntry e) {
