...
public abstract class DataRenderer extends Renderer {
    ...
    /**
     * Draws the value of the given chartEntry by using the provided IValueFormatter.
     *
     * @param c            canvas
     * @param formatter    formatter for custom value-formatting
     * @param value        the value to be drawn
     * @param chartEntry        the chartEntry the value belongs to
     * @param dataSetIndex the index of the DataSet the drawn ChartEntry belongs to
     * @param x            position
     * @param y            position
     * @param color
     */
    public void drawValue(Canvas c, IValueFormatter formatter, float value, ChartEntry chartEntry, int dataSetIndex, float x, float y, int color) {
        mValuePaint.setColor(color);
        c.drawText(formatter.getFormattedValue(value, chartEntry, dataSetIndex, mViewPortHandler), x, y, mValuePaint);
    }
