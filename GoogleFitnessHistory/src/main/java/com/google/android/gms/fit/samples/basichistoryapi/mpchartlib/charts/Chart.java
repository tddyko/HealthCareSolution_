...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.animation.EasingFunction;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.components.Description;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.components.IMarker;
...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.data.ChartData;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.data.ChartEntry;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.formatter.DefaultValueFormatter;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.formatter.IValueFormatter;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.highlight.ChartHighlighter;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.highlight.Highlight;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.highlight.IHighlighter;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.interfaces.dataprovider.ChartInterface;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.interfaces.datasets.IDataSet;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.listener.ChartTouchListener;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.listener.OnChartGestureListener;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.listener.OnChartValueSelectedListener;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.renderer.DataRenderer;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.renderer.LegendRenderer;
 ...
 */
@SuppressLint("NewApi")
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends ChartEntry>>> extends
        ViewGroup
     ...
     */
    private String mNoDataText = "차트 로딩중..";
    ...
    // for (int i = 0; i < 3; i++) {
    //
    // ArrayList<ChartEntry> yVals = new ArrayList<ChartEntry>();
    //
    // for (int j = 0; j < 12; j++) {
    // float val = (float) (Math.random() * 100);
    // yVals.add(new ChartEntry(val, j));
    // }
    //
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            ChartEntry e = mData.getEntryForHighlight(mIndicesToHighlight[i]);
