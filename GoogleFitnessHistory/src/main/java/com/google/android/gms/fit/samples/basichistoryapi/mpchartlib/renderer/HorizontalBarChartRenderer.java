...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.buffer.BarBuffer;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.buffer.HorizontalBarBuffer;
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i = 0, count = Math.min((int)(Math.ceil((float)(dataSet.getEntryCount()) * phaseX)), dataSet.getEntryCount());
                ...
                BarChartEntry e = dataSet.getEntryForIndex(i);
            ...
            for (int i = 0; i < mChart.getBarData().getDataSetCount(); i++) {
                ...
                if (!dataSet.isStacked()) {
                    ...
                    for (int j = 0; j < buffer.buffer.length * mAnimator.getPhaseX(); j += 4) {
                        ...
                        BarChartEntry entry = dataSet.getEntryForIndex(j / 4);
                    ...
                    while (index < dataSet.getEntryCount() * mAnimator.getPhaseX()) {
                        ...
                        BarChartEntry entry = dataSet.getEntryForIndex(index);
