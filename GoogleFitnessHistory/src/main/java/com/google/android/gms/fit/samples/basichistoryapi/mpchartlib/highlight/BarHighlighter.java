...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
    ...
    /**
     * This method creates the Highlight object that also indicates which value of a stacked BarChartEntry has been
     * selected.
     *
    ...
    public Highlight getStackedHighlight(Highlight high, IBarDataSet set, float xVal, float yVal) {
        ...
        BarChartEntry entry = set.getEntryForXValue(xVal, yVal);
...
//     * @return
//     */
//    protected Range[] getRanges(BarChartEntry entry) {
//
