...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.interfaces.dataprovider.BubbleDataProvider;
...
public class BubbleChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    protected void drawDataSet(Canvas c, IBubbleDataSet dataSet) {
        ...
        for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
            ...
            final BubbleChartEntry entry = dataSet.getEntryForIndex(j);
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            for (int i = 0; i < dataSets.size(); i++) {
                ...
                for (int j = 0; j < positions.length; j += 2) {
                    ...
                    BubbleChartEntry entry = dataSet.getEntryForIndex(j / 2 + mXBounds.min);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            final BubbleChartEntry entry = set.getEntryForXValue(high.getX(), high.getY());
