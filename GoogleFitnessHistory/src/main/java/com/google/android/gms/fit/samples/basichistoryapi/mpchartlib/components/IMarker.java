package com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.components;
...
public interface IMarker {
     ...
     *
     * @param e         The ChartEntry the IMarker belongs to. This can also be any subclass of ChartEntry, like BarChartEntry or
     *                  CandleChartEntry, simply cast it at runtime.
     * @param highlight The highlight object contains information about the highlighted value such as it's dataset-index, the
     *                  selected range or stack-index (only stacked bar entries).
     */
    void refreshContent(ChartEntry e, Highlight highlight);
