 ...
 */
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends ChartEntry>> {
    ...
    public void calcMinMax() {
        ...
        for (ChartData data : allData) {
            ...
            List<IBarLineScatterCandleBubbleDataSet<? extends ChartEntry>> sets = data.getDataSets();
    ...
    public ChartEntry getEntryForHighlight(Highlight highlight) {
        ...
        if (highlight.getDataSetIndex() >= data.getDataSetCount())
            ...
            List<ChartEntry> entries = data.getDataSetByIndex(highlight.getDataSetIndex())
                    .getEntriesForXValue(highlight.getX());
            for (ChartEntry chartEntry : entries)
                if (chartEntry.getY() == highlight.getY() ||
    ...
    @Override
    public boolean removeDataSet(IBarLineScatterCandleBubbleDataSet<? extends ChartEntry> d) {
