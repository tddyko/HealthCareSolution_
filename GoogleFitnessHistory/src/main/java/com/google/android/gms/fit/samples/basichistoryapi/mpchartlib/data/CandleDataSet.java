...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.interfaces.datasets.ICandleDataSet;
 ...
 */
public class CandleDataSet extends LineScatterCandleRadarDataSet<CandleChartEntry> implements ICandleDataSet {
    ...
    public CandleDataSet(List<CandleChartEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public DataSet<CandleChartEntry> copy() {

        List<CandleChartEntry> yVals = new ArrayList<CandleChartEntry>();
        yVals.clear();
    ...
    @Override
    protected void calcMinMax(CandleChartEntry e) {
    ...
    @Override
    protected void calcMinMaxY(CandleChartEntry e) {
