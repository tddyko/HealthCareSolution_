...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarChartEntry> implements IBarDataSet {
    ...
    public BarDataSet(List<BarChartEntry> yVals, String label) {
        super(yVals, label);
    ...
    @Override
    public DataSet<BarChartEntry> copy() {

        List<BarChartEntry> yVals = new ArrayList<BarChartEntry>();
        yVals.clear();
     ...
     */
    private void calcEntryCountIncludingStacks(List<BarChartEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(List<BarChartEntry> yVals) {
    ...
    @Override
    protected void calcMinMax(BarChartEntry e) {
