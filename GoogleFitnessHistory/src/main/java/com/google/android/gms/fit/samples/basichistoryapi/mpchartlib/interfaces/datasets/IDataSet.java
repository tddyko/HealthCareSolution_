 ...
 */
public interface IDataSet<T extends ChartEntry> {
    ...
    /**
     * Calculates the min and max y-values from the ChartEntry closest to the given fromX to the ChartEntry closest to the given toX value.
    ...
    /**
     * Returns the first ChartEntry object found at the given x-value with binary
     * search.
     * If the no ChartEntry at the specified x-value is found, this method
     * returns the ChartEntry at the closest x-value according to the rounding.
     ...
     *                 if there is no ChartEntry matching the provided x-value
     * @return
     *
     *
     */
     ...
     * search.
     * If the no ChartEntry at the specified x-value is found, this method
     * returns the ChartEntry at the closest x-value.
     * INFORMATION: This method does calculations at runtime. Do
     * not over-use in performance critical situations.
     *
     *
    ...
    /**
     * Returns all ChartEntry objects found at the given x-value with binary
     * search. An empty array if no ChartEntry object at that x-value.
     * INFORMATION: This method does calculations at runtime. Do
     * not over-use in performance critical situations.
     *
     * @param xValue
    ...
    /**
     * Returns the ChartEntry object found at the given index (NOT xIndex) in the values array.
     *
     * @param index
     * @return
     */
    ...
    /**
     * Returns the first ChartEntry index found at the given x-value with binary
     * search.
     * If the no ChartEntry at the specified x-value is found, this method
     * returns the ChartEntry at the closest x-value according to the rounding.
     * INFORMATION: This method does calculations at runtime. Do
    ...
    /**
     * Returns the position of the provided entry in the DataSets ChartEntry array.
     ...
     * index in the ChartEntry array of the DataSet for a given xIndex. IMPORTANT: This method does
    ...
    /**
     * Adds an ChartEntry to the DataSet dynamically.
    ...
    /**
     * Removes the first ChartEntry (at index 0) of this DataSet from the entries array.
    ...
    /**
     * Removes the last ChartEntry (at index size-1) of this DataSet from the entries array.
     * Returns true if successful, false if not.
     *
     * @return
     */
    ...
    /**
     * Removes an ChartEntry from the DataSets entries array. This will also
     * recalculate the current minimum and maximum values of the DataSet and the
     * value-sum. Returns true if an ChartEntry was removed, false if no ChartEntry could
     * be removed.
     *
     * @param e
     */
    ...
    /**
     * Removes the ChartEntry object closest to the given x-value from the DataSet.
     * Returns true if an ChartEntry was removed, false if no ChartEntry could be removed.
     *
     * @param xValue
     */
    ...
    /**
     * Removes the ChartEntry object at the given index in the values array from the DataSet.
     * Returns true if an ChartEntry was removed, false if no ChartEntry could be removed.
     *
     * @param index
     * @return
    ...
    /**
     * Checks if this DataSet contains the specified ChartEntry. Returns true if so,
