...
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.data.PieChartEntry;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.data.PieData;
import com.google.android.gms.fit.samples.basichistoryapi.mpchartlib.data.PieDataSet;
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                PieChartEntry entry = dataSet.getEntryForIndex(j);
