...
/**
 * The DataSet class represents one group or type of entries (ChartEntry) in the
 ...
 */
public abstract class DataSet<T extends ChartEntry> extends BaseDataSet<T> {
    ...
    /**
     * Updates the min and max x and y value of this DataSet based on the given ChartEntry.
     *
     * @param e
     */
    ...
    @Override
    public int getEntryIndex(ChartEntry e) {
        ...
        if (closest != -1) {
            ...
            if (!Float.isNaN(closestToY)) {
                ...
                while (true) {
                    ...
                    final ChartEntry value = mValues.get(closest);
