...
public class FileUtils {
     ...
     * @return
     */
    public static List<ChartEntry> loadEntriesFromFile(String path) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new ChartEntry(Float.parseFloat(split[0]), Integer.parseInt(split[1])));
                } else {
                    ...
                    entries.add(new BarChartEntry(Integer.parseInt(split[split.length - 1]), vals));
                }
            }
        } catch (IOException e) {
        ...
        // while ((line = br.readLine()) != null) {
        // String[] split = line.split("#");
        // entries.add(new ChartEntry(Float.parseFloat(split[0]),
     ...
     * @return
     */
    public static List<ChartEntry> loadEntriesFromAssets(AssetManager am, String path) {
        ...
        try {
            ...
            while (line != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new ChartEntry(Float.parseFloat(split[1]), Float.parseFloat(split[0])));
                } else {
     ...
     * @param path
     */
    public static void saveToSdCard(List<ChartEntry> entries, String path) {
    ...
    public static List<BarChartEntry> loadBarEntriesFromAssets(AssetManager am, String path) {
        ...
        try {
            ...
            while (line != null) {
                ...
                entries.add(new BarChartEntry(Float.parseFloat(split[1]), Float.parseFloat(split[0])));
        ...
        // String label = null;
        // ArrayList<ChartEntry> entries = new ArrayList<ChartEntry>();
        //
        // BufferedReader reader = null;
        // try {
        // reader = new BufferedReader(
