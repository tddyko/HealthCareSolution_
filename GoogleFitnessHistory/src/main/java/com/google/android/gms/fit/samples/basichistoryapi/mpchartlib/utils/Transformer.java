...
public class Transformer {
    ...
    /**
     * Transforms an List of ChartEntry into a float array containing the x and
    ...
    public float[] generateTransformedValuesScatter(IScatterDataSet data, float phaseX,
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            ChartEntry e = data.getEntryForIndex(j / 2 + from);
    ...
    public float[] generateTransformedValuesLine(ILineDataSet data,
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            ChartEntry e = data.getEntryForIndex(j / 2 + min);
    ...
    public float[] generateTransformedValuesCandle(ICandleDataSet data,
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            CandleChartEntry e = data.getEntryForIndex(j / 2 + from);
