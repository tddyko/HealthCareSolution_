...
/**
 * Subclass of ChartEntry that holds all values for one entry in a CandleStickChart.
 * 
 * @author Philipp Jahoda
 */
@SuppressLint("ParcelCreator")
public class CandleChartEntry extends ChartEntry {
     ...
     */
    public CandleChartEntry(float x, float shadowH, float shadowL, float open, float close) {
    ...
    public CandleChartEntry copy() {

        CandleChartEntry c = new CandleChartEntry(getX(), mShadowHigh, mShadowLow, mOpen,
                mClose, getData());
