 ...
 */
public abstract class ChartData<T extends IDataSet<? extends ChartEntry>> {
    ...
    /**
     * Get the ChartEntry for a corresponding highlight object
     *
     * @param highlight
     * @return the entry that is highlighted
     */
    public ChartEntry getEntryForHighlight(Highlight highlight) {
    ...
    /**
     * Adds an ChartEntry to the DataSet at the specified index.
     * Entries are added to the end of the list.
     *
     * @param e
     * @param dataSetIndex
     */
    public void addEntry(ChartEntry e, int dataSetIndex) {
        ...
        if (mDataSets.size() > dataSetIndex && dataSetIndex >= 0) {
            ...
            Log.e("addEntry", "Cannot add ChartEntry because dataSetIndex too high or too low.");
        }
    }

    /**
     * Adjusts the current minimum and maximum values based on the provided ChartEntry object.
     *
     * @param e
     * @param axis
     */
    protected void calcMinMax(ChartEntry e, AxisDependency axis) {
    ...
    /**
     * Removes the given ChartEntry object from the DataSet at the specified index.
     *
     * @param e
     * @param dataSetIndex
     */
    public boolean removeEntry(ChartEntry e, int dataSetIndex) {
    ...
    /**
     * Removes the ChartEntry object closest to the given DataSet at the
     * specified index. Returns true if an ChartEntry was removed, false if no ChartEntry
    ...
    public boolean removeEntry(float xValue, int dataSetIndex) {
        ...
        ChartEntry e = dataSet.getEntryForXValue(xValue, Float.NaN);
    ...
    /**
     * Returns the DataSet that contains the provided ChartEntry, or null, if no
     * DataSet contains this ChartEntry.
     *
     * @param e
     * @return
     */
    public T getDataSetForEntry(ChartEntry e) {
